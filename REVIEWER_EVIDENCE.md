...
The implementation below was present before review in commit
...
The later documentation commit only improves evidence discovery.
...
| Application connection handler | [`frontend/src/state/CommitPassProvider.tsx`](https://github.com/himanshu748/commitpass-stellar-rsvp/blob/main/frontend/src/state/CommitPassProvider.tsx#L529-L577) connects and disconnects the live wallet. |
| Visible connect UI | [`frontend/src/components/AppHeader.tsx`](https://github.com/himanshu748/commitpass-stellar-rsvp/blob/main/frontend/src/components/AppHeader.tsx#L68-L105) mounts the live connect and disconnect handlers. The visible button is rendered at [lines 205 to 220](https://github.com/himanshu748/commitpass-stellar-rsvp/blob/main/frontend/src/components/AppHeader.tsx#L205-L220). |
...
| Deployed contract configuration | [`frontend/src/lib/seed.ts`](https://github.com/himanshu748/commitpass-stellar-rsvp/blob/main/frontend/src/lib/seed.ts#L13-L32) loads the public contract into the application. |
| Frontend contract call | [`CommitPassProvider.tsx`](https://github.com/himanshu748/commitpass-stellar-rsvp/blob/main/frontend/src/state/CommitPassProvider.tsx#L727-L776) invokes `create_event` through the live generated client. |
...
| Frontend tests | [`frontend/src`](https://github.com/himanshu748/commitpass-stellar-rsvp/tree/main/frontend/src) contains the 53 passing Vitest tests. |
