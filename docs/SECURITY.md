...
The original broad wallet aggregator pulled unused hardware and cross-chain
wallet branches with vulnerable transitive dependencies. It was replaced by
direct Freighter and Albedo adapters. The production dependency audit then
reported zero known vulnerabilities at the time of release.
